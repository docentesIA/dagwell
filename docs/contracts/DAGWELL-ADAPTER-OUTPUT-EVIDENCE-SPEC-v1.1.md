# DAGWELL — Adapter / Output Evidence Specification · v1.1

> Status: PROMOTED — NORMATIVE. Human gate: 2026-09-04 (America/Belem).
...
Approved by Reinaldo on 2026-09-04 in response to the explicit v1.1-RC1
promotion question. No content amendments. The predecessor v1.1-RC1 and
v1.0 remain intact; this promoted addendum is pinned in MANIFEST.sha256.
